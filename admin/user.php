                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="mb-3">
														...
														<select name="role" class="form-control">
															...
															// Ambil tipe kolom 'role' dari tabel 'user' menggunakan SHOW COLUMNS
															...
															// Ambil nilai ENUM dari kolom 'role'
															$enum_values = substr($row['Type'], 5, -1); // Menghapus 'enum(' dan ')'
															$enum_values = str_replace("'", "", $enum_values); // Menghapus tanda petik
															$enum_values = explode(",", $enum_values); // Pisahkan nilai-nilai ENUM berdasarkan koma

															// Loop untuk menampilkan setiap nilai ENUM sebagai pilihan dalam dropdown
															foreach ($enum_values as $role) {
																$role = trim($role); // Menghilangkan spasi ekstra jika ada
