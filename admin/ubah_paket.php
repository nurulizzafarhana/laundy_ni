									...
									<div class="mb-18">
										...
										<div class="mb-10">
											<!--begin::Top-->
                                                ...
                                                <form action="./admin/proses_ubah_paket.php" method="post">
                                                ...
                                                <div class="mb-3" style="text-align: left;">
                                                    <strong><label class="col-lg-4 col-form-label" for="val-username">Id Paket<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-username" name="id_paket" placeholder="Enter id kelas.." value="<?= $data['id_paket']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                ...
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-password">Jenis Paket<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-password" name="jenis" placeholder="Enter the jurusan..." value="<?= $data['jenis']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-password">Nama Paket<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-password" name="nama_paket" placeholder="Enter the angkatan..." value="<?= $data['nama_paket']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-password">Harga<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-password" name="harga" placeholder="Enter the angkatan..." value="<?= $data['harga']?>">
                                                    </div>
                                                </div>
                                                <br><br>
