										...
										<div class="mb-10">
											<!--begin::Top-->
                                                ...
                                                ?>
                                                    ...
                                                    <div class="mb-3" style="text-align: left;">
														<strong><label class="col-lg-4 col-form-label" for="role">Role User<span class="text-danger">*</span></label></strong>
														<div class="col-lg-12">
															<select class="form-control" id="role" name="role">
																<option value="">Pilih Role</option>
																<?php
																// Definisikan pilihan role ENUM di sini
																$roles = ['admin', 'kasir', 'owner'];

																// Iterasi dan tampilkan opsi dropdown
																foreach ($roles as $role) {
																	// Cek apakah role yang ada pada data sudah sesuai dengan pilihan
																	$selected = ($data['role'] == $role) ? 'selected' : '';
