						...
						<div class="aside-nav d-flex flex-column flex-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								<div class="menu-item py-2">
									<a class="menu-link active menu-center" href="kasir/index_kasir.php" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-body d-flex flex-column justify-content-between h-100">
											...
											<div class="pt-12">
												...
												<!--end::Title-->
												<!--begin::Text-->
												<div class="text-center text-gray-600 fs-5 fw-bold pt-4">Terimakasih telah bergabing di LaundryApp. <br>Anda login menggunakan akun Kasir.</div>
												<!--end::Text-->
												<!--begin::Action-->
												<div class="text-center py-7 mb-18">
													<a href="owner/index_owner.php" class="btn btn-primary fs-6 px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Mulai Sekarang!</a>
												</div>
												<!--end::Action-->
											</div>
											<!--end::Section-->
									...
									<div class="card card-xxl-stretch mb-5 mb-xxl-8">
										...
										<div class="card-header border-0 pt-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-boldest fs-3 text-dark">Halaman Dashboard Kasir</span>
