							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<!-- <div class="menu-item">
											<a class="menu-link" href="./kasir/user.php" data-kt-page="pro">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
						...
						<div class="aside-workspace overflow-auto my-2 my-lg-7 px-3 px-lg-7" id="kt_aside_wordspace">
							...
							<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
								<div id="kt_aside_menu_wrapper" class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-offset="20px" data-kt-scroll-wrappers="#kt_aside_wordspace">
									...
									<div class="menu-item">
										<a class="menu-link active" href="./kasir/index_kasir.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
								...
								<div class="card-body p-lg-17">
									...
									<div class="mb-18">
										...
										<?php
											...
											// Periksa apakah id_transaksi ada di URL
											if (isset($_GET['id_transaksi']) && !empty($_GET['id_transaksi'])) {
												...
												if ($result && mysqli_num_rows($result) > 0) {
													while ($data_member = mysqli_fetch_assoc($result)) {
														?>
														<!-- Tombol kembali dan cetak laporan -->
														...
														<!-- Data transaksi yang ditampilkan dalam tabel -->
														<table>
															<tr>
															...
															<tr>
																...
																<td></td>
																<td class="fw-bold fs-6"><?=$data_member['kode_transaksi']?></td>
															</tr>
															<tr>
															...
															<tr>
																<td class="col-lg-4 fw-bold text-muted">Nominal Bayar</td>
																<td></td>
																<td class="fw-bold fs-6"><?= number_format($data_member['dibayar'], 0, ',', '.') ?></td>
															</tr>
													...
													echo "<p>Tidak ada data transaksi ditemukan untuk ID Transaksi: $id_transaksi</p>";
												}
											} else {
												echo "<p>ID Transaksi tidak valid atau tidak ditemukan.</p>";
											}
											?>
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											if (isset($_GET['id_transaksi']) && !empty($_GET['id_transaksi'])) {
												...
												$qry_pembayaran = mysqli_query($conn, "SELECT transaksi.*, detail_transaksi.*, paket.nama_paket, paket.harga 
																					FROM transaksi 
												...
												if ($qry_pembayaran && mysqli_num_rows($qry_pembayaran) > 0) {
													$no = 0;
													while ($data_pembayaran = mysqli_fetch_array($qry_pembayaran)) {
														...
														<tr class="text-xs font-weight-bold">
															...
															<td class="align-middle text-left"><?=$data_pembayaran['kode_transaksi']?></td>
															...
															<td class="align-middle text-left">Rp <?= number_format($data_pembayaran['harga'], 0, ',', '.') ?></td>
															<td class="align-middle text-left">Rp <?= number_format($total, 0, ',', '.') ?></td>
															<td class="align-middle text-left">
																<a class="btn btn-success" href="kasir/ubah_detail_transaksi.php?id_transaksi=<?=$data_pembayaran['id_transaksi']?>">
												...
												echo "<tr><td colspan='9'>ID Transaksi tidak ditemukan.</td></tr>";
											}
											?>
										</tbody>
									</table>
