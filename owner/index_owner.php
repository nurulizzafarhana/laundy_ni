						...
						<div class="aside-nav d-flex flex-column flex-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								<div class="menu-item py-2">
									<a class="menu-link active menu-center" href="owner/index_owner.php" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									<span class="menu-link menu-center" title="Transaksi" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon me-0">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link" href="owner/transaksi.php" title="Silahkan melakukan registrasi pelanggan baru" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-body d-flex flex-column justify-content-between h-100">
											...
											<div class="pt-12">
												...
												<!--end::Title-->
												<!--begin::Text-->
												<div class="text-center text-gray-600 fs-5 fw-bold pt-4">Terimakasih telah bergabing di LaundryApp. <br>Anda login menggunakan akun OWNER.</div>
												<!--end::Text-->
												<!--begin::Action-->
												<div class="text-center py-7 mb-18">
													<a href="owner/transaksi.php" class="btn btn-primary fs-6 px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Mulai Sekarang!</a>
												</div>
												<!--end::Action-->
											</div>
											<!--end::Section-->
									...
									<div class="card card-xxl-stretch mb-5 mb-xxl-8">
										...
										<div class="card-header border-0 pt-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-boldest fs-3 text-dark">Halaman Dashboard OWNER</span>
												<span class="text-gray-400 mt-2 fw-bold fs-6">Jumlah Data SWOG Laundry</span>
											</h3>
											<!--end::Card title-->
